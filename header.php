    ...
    <div class="header__wrapper">
        <div class="header__container">
            <div class="logo__container">
                <a href="#">
                    <img src="<?php echo get_template_directory_uri() ?>/img/logo.png" alt="conference logo"
                         class="logo__item">
                </a>
            ...
            <nav class="nav__wrapper">
                <ul class="nav__container nav__container--js mobile--hidden">
                    ...
                    <li class="nav__item"><a href="#blog" class="nav__link"><span class="nav__text" style="color: #163E6F">BLOG</span></a></li>
                    <li class="nav__item">
                        <div class="nav__btn">
                            <a href="#register" class="btn js-navBtn">Bilety i rejestracja
